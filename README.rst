...
Page rendering
The HTML, CSS, and JavaScript files that are contained in a response from a web server are processed by a browser in order to render the web page.

Interpreting the HTML and CSS code, rendering any images or other media that are included on the page, and running any JavaScript code that is present on the page are all steps in the rendering process.

In your situation, the HTML, CSS, and JavaScript files that make up the Google web page would be delivered by the web server to your browser.
...
putting the content and images on the page where they belong.

the text and layout are formatted using CSS styles

running all JavaScript scripts on the page
